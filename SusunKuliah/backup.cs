...
namespace SusunKuliah
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
                ...
                foreach (KeyValuePair<string, List<string>> entry in mapKuliah)
                {
                    ...
                    string namaGambar = "Gambar" + counterGambar + ".png";
                    
                    string Lokasi = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\Gambar\\" + namaGambar;

                    bitmap.Save(Lokasi);  
                }

                //Tampilkan gambar pertama
                ImageBox1.Source = new BitmapImage(new Uri(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\Gambar\\" + "Gambar" + "1" + ".png"));
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            counterGambarTampil = Math.Min(counterGambar, temp);
            string namaGambar = "Gambar" + counterGambarTampil + ".png";
            string Lokasi = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\Gambar\\" + namaGambar;
            ImageBox1.Source = new BitmapImage(new Uri(Lokasi));
        }
